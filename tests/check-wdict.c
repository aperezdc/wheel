...
{
    w_dict_t *d = w_dict_new ();

    w_dict_set (d, "foo", "FOO");
    fail_unless (w_dict_count (d) == 1,
...
{
    w_dict_t *d1 = w_dict_new ();
    w_dict_t *d2 = w_dict_new ();
